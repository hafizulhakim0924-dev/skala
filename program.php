...
<div class="container">
    <div class="card-header">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
            ...
            <a href="import_program.php?template=1" class="btn">📄 Template CSV</a>
            <button type="button" class="btn" onclick="document.getElementById('modalImportProgram').style.display='block'">📤 Import Excel</button>
...
<!-- Modal Import Excel -->
<div id="modalImportProgram" class="modal">
    <div class="modal-content" style="max-width:480px">
        <span class="close" onclick="document.getElementById('modalImportProgram').style.display='none'">&times;</span>
        <h2>Import Program dari Excel</h2>
        <p style="font-size:12px;color:var(--light-text);margin-bottom:12px">
            Unggah file <strong>.csv</strong> atau <strong>.xls</strong> (format sama dengan export).
            <a href="import_program.php?template=1">Unduh template CSV</a>
        </p>
        <form method="POST" action="import_program.php" enctype="multipart/form-data">
            <div class="form-group">
                <label>File</label>
                <input type="file" name="file_import" accept=".csv,.xls,.xlsx" required>
            </div>
            <div class="text-right" style="margin-top:16px">
                <button type="button" class="btn" onclick="document.getElementById('modalImportProgram').style.display='none'">Batal</button>
